...
# Explicitly excluded because they represent targets or
# other future outcomes that should not be predictors.
LEAKAGE_COLUMNS = [
    "FutureCostOverrun",
    "FutureTimeOverrun",
    "OverallRiskEvent",
...
print("=" * 70)
print("PRISM — TIME OVERRUN MODEL")
print("=" * 70)
...
metadata = {
    ...
    "training_projects":
        int(
            train_df["ProjectCode"].nunique()
        ),

    "testing_projects":
        int(
            test_df["ProjectCode"].nunique()
        )
}
...
print("\n" + "=" * 70)
print("TIME MODEL TRAINING COMPLETE")
print("=" * 70)